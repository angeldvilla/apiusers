...
public function getUser($id_user){
    ...
    $conexion = new Conexion();
    $db = $conexion->getConexion();
    $sql = "SELECT id_user, username, name, lastname, email, cellphone FROM users WHERE id=:id";
    $consulta = $db->prepare($sql);
...
//AGREGAR UN USUARIO ESPECIFICO
public function addUser($username, $password, $name, $lastname, $email, $cellphone){
  
  $conexion = new Conexion();
  $db = $conexion->getConexion();
  $sql = "INSERT INTO users (username, password, name, lastname, email, cellphone) VALUES (:username,:password, :name, :lastaname, :email, :cellphone)";
  $consulta = $db->prepare($sql);
...
//ACTUALIZAR UN LIBRO ESPECIFICO
